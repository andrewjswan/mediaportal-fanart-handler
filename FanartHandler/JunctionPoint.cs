...
namespace Monitor.Core.Utilities
{
  ...
  public static class JunctionPoint
  {
    ...
    /// <summary>
    /// Reparse point tag used to identify symlink.
    /// </summary>
    ...
    private struct REPARSE_DATA_BUFFER
    {
      ...
      // Symlinks has ulong Flags here, therefore buffer start is shifted
    ...
    private static string InternalGetTarget(SafeFileHandle handle)
    {
      ...
      try
      {
        ...
        if (reparseDataBuffer.ReparseTag != IO_REPARSE_TAG_MOUNT_POINT && reparseDataBuffer.ReparseTag != IO_REPARSE_TAG_SYMLINK)
          return null;
